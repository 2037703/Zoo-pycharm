...
class Ui_Mammifere(object):
    def setupUi(self, Mammifere):
        ...
        self.label_err_general_mam = QtWidgets.QLabel(Mammifere)
        self.label_err_general_mam.setGeometry(QtCore.QRect(250, 78, 291, 41))
        self.label_err_general_mam.setObjectName("label_err_general_mam")
    ...
    def retranslateUi(self, Mammifere):
        ...
        self.label_err_general_mam.setText(_translate("Mammifere", ""))
