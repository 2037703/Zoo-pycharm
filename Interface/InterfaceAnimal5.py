...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.lineEdit_poid_mammifere = QtWidgets.QLineEdit(Dialog)
        self.lineEdit_poid_mammifere.setGeometry(QtCore.QRect(30, 430, 171, 41))
        self.lineEdit_poid_mammifere.setObjectName("lineEdit_poid_mammifere")
        self.label_err_nom_mam = QtWidgets.QLabel(Dialog)
        self.label_err_nom_mam.setGeometry(QtCore.QRect(30, 340, 221, 41))
        self.label_err_nom_mam.setObjectName("label_err_nom_mam")
        self.label_err_poid_mam = QtWidgets.QLabel(Dialog)
        self.label_err_poid_mam.setGeometry(QtCore.QRect(30, 470, 221, 41))
        ...
        self.lineEdit_nom_mammifere = QtWidgets.QLineEdit(Dialog)
        self.lineEdit_nom_mammifere.setGeometry(QtCore.QRect(30, 300, 171, 41))
        self.lineEdit_nom_mammifere.setObjectName("lineEdit_nom_mammifere")
        self.comboBox_regime_mammifere = QtWidgets.QComboBox(Dialog)
        self.comboBox_regime_mammifere.setGeometry(QtCore.QRect(260, 430, 171, 41))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_err_nom_mam.setText(_translate("Dialog", "<html><head/><body><p><span style=\" color:#ff0000;\">Doit être composée de lettre seulement</span></p></body></html>"))
        self.label_err_poid_mam.setText(_translate("Dialog", "<html><head/><body><p><span style=\" color:#ff0000;\">Doit être supérieure à zéro</span></p></body></html>"))
